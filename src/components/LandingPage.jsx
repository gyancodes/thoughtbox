          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Your thoughts,
                <span className="text-blue-600"> encrypted</span> and
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Your notes are encrypted before leaving your device</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Access your notes from anywhere, anytime</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Multiple Note Types</h3>
                  <p className="text-gray-600 text-sm">Text notes, todo lists, and timetables</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Work without internet, sync when connected</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6 pt-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">Zero-knowledge architecture</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <section id="security" className="py-16 lg:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Military-grade encryption protects your data with the same standards used by governments</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Zero Knowledge</h3>
              <p className="text-gray-600">We can't read your notes even if we wanted to. Your encryption keys never leave your device</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Our code is transparent and auditable. Security through transparency, not obscurity</p>
            </div>
          </div>
        </section>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900">ThoughtBox</span>
            </div>
