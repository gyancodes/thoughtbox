          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-lg font-medium text-[var(--text-primary)]">ThoughtBox</h1>
              </div>
...
const DashboardContent = ({  onEditNote }) => {
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-[var(--text-secondary)]">Loading your notes...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-[var(--bg-tertiary)] border border-[var(--border-primary)] rounded p-6 text-center">
        <svg className="w-12 h-12 text-[var(--text-tertiary)] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
        </svg>
        <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2">Error Loading Notes</h3>
    ...
    <div className="space-y-6">
      ...
      {notes.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-[var(--text-secondary)] mb-6">Start by creating your first note above.</p>
        </div>
      ) : (
        <NoteGrid 
